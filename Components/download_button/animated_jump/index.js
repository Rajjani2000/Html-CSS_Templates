...
document.querySelectorAll(".dl-parachute").forEach((button) => {
    ...
    line = new Proxy(
      ...
      },
      {
        set(target, key, value) {
          target[key] = value;
          if (target.y !== null) {
            button.querySelector(".line").innerHTML = getPath(target.y, 0.2);
          }
          return true;
        },
        get(target, key) {
  ...
  button.addEventListener("click", (e) => {
    ...
    gsap
      ...
      .to(circle, {
        morphSVG:
          "M10 120.5C11.5 120.5 29.1914 120.5 61.5 120.5C78.5 120.5 108.054 120.777 140.5 120.5C172.67 120.225 201.5 120.5 218.5 120.5C250.397 120.5 268.5 120.5 270 120.5",
        duration: 0.15,
        onComplete() {
          gsap.set(button, {
            "--circle-opacity": 0,
